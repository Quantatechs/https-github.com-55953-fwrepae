...
/**
 * DataForBalanceLimitsSearch Class Doc Comment
 *
 * @category Class
 ...
 */
class DataForBalanceLimitsSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataForBalanceLimitsSearch';
    ...
    */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\Group[]|null $groups The groups the authenticated user can use to filter.
     *
     * @return self
     */
     ...
     * Sets account_types
     *
     * @param \OpenAPI\Client\Model\AccountType[]|null $account_types The account types that can be used to filter.
     *
     * @return self
     */
