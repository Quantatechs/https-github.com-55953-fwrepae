<?php
/**
 * TransferDataForSearchAllOfQuery
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * TransferDataForSearchAllOfQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class TransferDataForSearchAllOfQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferDataForSearch_allOf_query';
    ...
    */
     ...
     * Sets currencies
     *
     * @param string[]|null $currencies Either ids or internal names of the currency
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $from_account_types Either ids or internal names of the origin account type
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $to_account_types Either ids or internal names of the destination account type
     *
     * @return self
     */
