 ...
 */
class RecordTypeDetailed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecordTypeDetailed';
    ...
    protected static $openAPITypes = [
        ...
        'sections' => '\OpenAPI\Client\Model\RecordSection[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('field_columns', $data ?? [], null);
        $this->setIfExists('nowrap_labels', $data ?? [], null);
    ...
    */
     ...
     * Sets field_columns
     *
     * @param int|null $field_columns The number of columns which should be used to layout fields
     *
     * @return self
     */
    public function setFieldColumns($field_columns)
    {
        if (is_null($field_columns)) {
            throw new \InvalidArgumentException('non-nullable field_columns cannot be null');
        }
     ...
     * Sets nowrap_labels
     *
     * @param bool|null $nowrap_labels Indicates whether labels in the form should be prevented from wrapping lines
     *
     * @return self
     */
    public function setNowrapLabels($nowrap_labels)
    {
        if (is_null($nowrap_labels)) {
            throw new \InvalidArgumentException('non-nullable nowrap_labels cannot be null');
        }
     ...
     *
     * @param string|null $information_text An informative text that should be shown in the form. The text is formatted in HTML.
     *
     * @return self
     */
     ...
     * Gets sections
     *
     * @return \OpenAPI\Client\Model\RecordSection[]|null
     */
     ...
     * Sets sections
     *
     * @param \OpenAPI\Client\Model\RecordSection[]|null $sections The field sections in this record type
     *
     * @return self
     */
