<?php
/**
 * NestedErrorAllOfForbiddenError
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * NestedErrorAllOfForbiddenError Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedErrorAllOfForbiddenError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedError_allOf_forbiddenError';
    ...
    protected static $openAPITypes = [
        'password_type' => '\OpenAPI\Client\Model\EntityReference',
        'max_device_activation_reached' => 'bool',
        'code' => '\OpenAPI\Client\Model\ForbiddenErrorCode',
    ...
    protected static array $openAPINullables = [
        'password_type' => false,
        'max_device_activation_reached' => false,
        'code' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('max_device_activation_reached', $data ?? [], null);
    ...
    */
     ...
     * Sets password_type
     *
     * @param \OpenAPI\Client\Model\EntityReference|null $password_type password_type
     *
     * @return self
     */
     ...
     *
     * @param bool|null $max_device_activation_reached The maximum attemps for a device activation was reached. The authenticated user is blocked. Only sent if `code` is `invalidDeviceActivationCode`
     *
     * @return self
     */
    public function setMaxDeviceActivationReached($max_device_activation_reached)
    {
        if (is_null($max_device_activation_reached)) {
            throw new \InvalidArgumentException('non-nullable max_device_activation_reached cannot be null');
        }
     ...
     * Gets code
     *
     * @return \OpenAPI\Client\Model\ForbiddenErrorCode|null
     */
     ...
     * Sets code
     *
     * @param \OpenAPI\Client\Model\ForbiddenErrorCode|null $code code
     *
     * @return self
     */
