...
/**
 * UserOperatorsQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class UserOperatorsQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserOperatorsQueryFilters';
    ...
    */
     ...
     * Sets keywords
     *
     * @param string|null $keywords Used to filter operators containing that keywords in the the username or name (case insensitive)
     *
     * @return self
     */
     ...
     * Sets statuses
     *
     * @param \OpenAPI\Client\Model\UserStatusEnum[]|null $statuses statuses
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $operator_groups An array of operator group ids
     *
     * @return self
     */
