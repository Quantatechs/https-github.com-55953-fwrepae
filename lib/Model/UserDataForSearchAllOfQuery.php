...
/**
 * UserDataForSearchAllOfQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class UserDataForSearchAllOfQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserDataForSearch_allOf_query';
    ...
    protected static $openAPITypes = [
        ...
        'order_by' => '\OpenAPI\Client\Model\UserOrderByEnum'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('contacts_owner', $data ?? [], null);
        $this->setIfExists('exclude_contacts', $data ?? [], null);
        $this->setIfExists('from_menu', $data ?? [], null);
    ...
    */
     ...
     * Sets contacts_owner
     *
     * @param string|null $contacts_owner Indicates the (managed) user to exclude contacts when `excludecontacts` is set. Defaults to the logged user.
     *
     * @return self
     */
    public function setContactsOwner($contacts_owner)
    {
        if (is_null($contacts_owner)) {
            throw new \InvalidArgumentException('non-nullable contacts_owner cannot be null');
        }
     ...
     *
     * @param bool|null $exclude_contacts When set to `true` will not return any user that is already a contact of the user indicated on `contactsOwner` (the logged user if not set).
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getFromMenu()
    {
        return $this->container['from_menu'];
    }

    /**
     * Sets from_menu
     *
     * @param bool|null $from_menu When set to true the search will be restricted to those groups defined for the user search menu, if false then for those defined in the 'Search users on groups' product setting (or in the configuration in case of guests).
     *
     * @return self
     */
    public function setFromMenu($from_menu)
    {
        if (is_null($from_menu)) {
            throw new \InvalidArgumentException('non-nullable from_menu cannot be null');
        }
        $this->container['from_menu'] = $from_menu;
     ...
     * Sets roles
     *
     * @param \OpenAPI\Client\Model\RoleEnum[]|null $roles roles
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \OpenAPI\Client\Model\UserOrderByEnum|null
     */
     ...
     * Sets order_by
     *
     * @param \OpenAPI\Client\Model\UserOrderByEnum|null $order_by order_by
     *
     * @return self
     */
