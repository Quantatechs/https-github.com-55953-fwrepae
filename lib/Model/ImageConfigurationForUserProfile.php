 ...
 */
class ImageConfigurationForUserProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageConfigurationForUserProfile';
    ...
    */
     ...
     * Sets manage
     *
     * @param bool|null $manage Can the authenticated user has permission to manage images?
     *
     * @return self
     */
     ...
     * Sets max_images
     *
     * @param int|null $max_images The maximum allowed number of profile images
     *
     * @return self
     */
