...
/**
 * UserDataForNewAllOfGroup Class Doc Comment
 *
 * @category Class
 ...
 */
class UserDataForNewAllOfGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserDataForNew_allOf_group';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description The description set on the group to be displayed to the user
     *
     * @return self
     */
