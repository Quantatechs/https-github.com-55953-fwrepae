...
/**
 * InstallmentPreview Class Doc Comment
 *
 * @category Class
 ...
 */
class InstallmentPreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstallmentPreview';
    ...
    */
     ...
     * Sets total_amount
     *
     * @param float|null $total_amount The final total installment amount
     *
     * @return self
     */
     ...
     * Sets main_amount
     *
     * @param float|null $main_amount Depending on the configured fees, it could happen that the main amount is deducted from fees amount. This reflects the new main amount. If no fees deduct, it will be the same as `totalAmount`.
     *
     * @return self
     */
