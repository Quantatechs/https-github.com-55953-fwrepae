...
class OrderNew implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'draft' => 'bool',
        'remarks' => 'string',
        'items' => '\OpenAPI\Client\Model\OrderItemManage[]',
        'currency' => 'string',
        'buyer' => 'string'
    ];
    ...
    */
     ...
     * Sets draft
     *
     * @param bool|null $draft If `true` then the order is saved with status `draft` and is visible only for the seller. Otherwise, the order is saved with status `pendingBuyer` and sent to the buyer for acceptance.
     *
     * @return self
     */
     ...
     * Sets remarks
     *
     * @param string|null $remarks Remarks shown to the buyer if set
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\OrderItemManage[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\OrderItemManage[]|null $items The order items
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Either internal name or id of the order currency.
     *
     * @return self
     */
     ...
     * Sets buyer
     *
     * @param string|null $buyer Either internal id or other accepted identification (username, e-mail, etc) for the buyer
     *
     * @return self
     */
