 ...
 */
class DataForEasyInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataForEasyInvoice';
    ...
    protected static $openAPITypes = [
        'to' => '\OpenAPI\Client\Model\User',
        'amount' => 'float',
        'currency' => '\OpenAPI\Client\Model\Currency',
        'payment_type_data' => '\OpenAPI\Client\Model\TransactionTypeData',
        'device_confirmation_availability' => '\OpenAPI\Client\Model\AvailabilityEnum',
    ...
    protected static array $openAPINullables = [
        ...
        'device_confirmation_availability' => false,
        'payment_types' => false,
        'custom_values' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('device_confirmation_availability', $data ?? [], null);
    ...
    */
     ...
     * Sets to
     *
     * @param \OpenAPI\Client\Model\User|null $to to
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The easy invoice amount
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AvailabilityEnum|null $device_confirmation_availability device_confirmation_availability
     *
     * @return self
     */
    public function setDeviceConfirmationAvailability($device_confirmation_availability)
    {
        if (is_null($device_confirmation_availability)) {
            throw new \InvalidArgumentException('non-nullable device_confirmation_availability cannot be null');
        }
     ...
     * Sets payment_types
     *
     * @param \OpenAPI\Client\Model\TransferTypeWithCurrency[]|null $payment_types Only returned if there is a logged user, and a specific payment type was not informed. Contains the allowed payment types to the given user.
     *
     * @return self
     */
     ...
     * Sets custom_values
     *
     * @param \OpenAPI\Client\Model\CustomFieldValue[]|null $custom_values The list of custom field values with a fixed value, as requested.
     *
     * @return self
     */
