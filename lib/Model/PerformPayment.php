 ...
 */
class PerformPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PerformPayment';
    ...
    */
    ...
    public function setInstallmentsCount($installments_count)
    {
        ...
        if (($installments_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $installments_count when calling PerformPayment., must be bigger than or equal to 1.');
        }
    ...
    public function setOccurrencesCount($occurrences_count)
    {
        ...
        if (($occurrences_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $occurrences_count when calling PerformPayment., must be bigger than or equal to 1.');
        }
