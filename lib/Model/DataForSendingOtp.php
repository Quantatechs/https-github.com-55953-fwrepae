...
/**
 * DataForSendingOtp Class Doc Comment
 *
 * @category Class
 ...
 */
class DataForSendingOtp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataForSendingOtp';
    ...
    protected static $openAPITypes = [
        'mediums' => '\OpenAPI\Client\Model\SendMediumEnum[]',
        'email' => 'string',
    ...
    {
        $this->setIfExists('mediums', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['mediums'];
    }

    /**
     * Sets mediums
     *
     * @param \OpenAPI\Client\Model\SendMediumEnum[]|null $mediums The available mediums for the user to receive the OTP. an activation code.
     *
     * @return self
     */
    ...
    {
        if (is_null($mediums)) {
            throw new \InvalidArgumentException('non-nullable mediums cannot be null');
        }
        $this->container['mediums'] = $mediums;
     ...
     * Sets email
     *
     * @param string|null $email The email to send the code if the selected medium is `email`.
     *
     * @return self
     */
     ...
     * Sets phones
     *
     * @param \OpenAPI\Client\Model\Phone[]|null $phones The available mobile phones to send the code. Verified and unverified phones will be included in this list. After a successful activation if the phone was not yet verified then it will automatically be marked as verified.
     *
     * @return self
     */
     ...
     *
     * @param int|null $verification_code_seconds The number of seconds an OTP may be sent again.
     *
     * @return self
     */
