...
/**
 * AuthAllOfPinInput Class Doc Comment
 *
 * @category Class
 ...
 */
class AuthAllOfPinInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Auth_allOf_pinInput';
    ...
    */
     ...
     * Sets min_length
     *
     * @param int|null $min_length The minimum allowed PIN length
     *
     * @return self
     */
     ...
     * Sets max_length
     *
     * @param int|null $max_length The maximum allowed PIN length
     *
     * @return self
     */
