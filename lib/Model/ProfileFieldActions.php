...
/**
 * ProfileFieldActions Class Doc Comment
 *
 * @category Class
 ...
 */
class ProfileFieldActions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProfileFieldActions';
    ...
    */
     ...
     * Sets edit
     *
     * @param bool|null $edit Can the authenticated user edit this field?
     *
     * @return self
     */
     ...
     * Sets manage_privacy
     *
     * @param bool|null $manage_privacy Can the authenticated user manage the visibility of this field for other users? Note that this is not related to the privacy setting, which uses the privacy controls, and are more general (not per field).
     *
     * @return self
     */
