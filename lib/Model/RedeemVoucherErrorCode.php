...
class RedeemVoucherErrorCode
{
    ...
    public const NOT_ALLOWED_FOR_USER = 'notAllowedForUser';

    public const NOT_ALLOWED_FOR_VOUCHER = 'notAllowedForVoucher';

    public const NOT_ALLOWED_TODAY = 'notAllowedToday';

    public const NOT_ALLOWED_YET = 'notAllowedYet';

    public const PAYMENT = 'payment';

    public const UNEXPECTED = 'unexpected';

    public const USER_BLOCKED = 'userBlocked';
