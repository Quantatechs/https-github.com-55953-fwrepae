<?php
/**
 * InstallmentOverviewResultAllOfTransaction
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * InstallmentOverviewResultAllOfTransaction Class Doc Comment
 *
 * @category Class
 ...
 */
class InstallmentOverviewResultAllOfTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstallmentOverviewResult_allOf_transaction';
    ...
    protected static $openAPITypes = [
        ...
        'from' => '\OpenAPI\Client\Model\TransactionOverviewResultAllOfFrom',
        'from_name' => 'string',
        'to' => '\OpenAPI\Client\Model\TransactionOverviewResultAllOfTo',
        'to_name' => 'string'
    ];
    ...
    */
     ...
     * Gets from
     *
     * @return \OpenAPI\Client\Model\TransactionOverviewResultAllOfFrom|null
     */
     ...
     * Sets from
     *
     * @param \OpenAPI\Client\Model\TransactionOverviewResultAllOfFrom|null $from from
     *
     * @return self
     */
     ...
     * Gets to
     *
     * @return \OpenAPI\Client\Model\TransactionOverviewResultAllOfTo|null
     */
     ...
     * Sets to
     *
     * @param \OpenAPI\Client\Model\TransactionOverviewResultAllOfTo|null $to to
     *
     * @return self
     */
