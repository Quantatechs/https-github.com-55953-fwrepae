...
/**
 * SearchByDistanceData Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchByDistanceData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchByDistanceData';
    ...
    */
     ...
     * Sets addresses
     *
     * @param \OpenAPI\Client\Model\Address[]|null $addresses The list of addresses owned by the authenticated user
     *
     * @return self
     */
     ...
     * Sets default_values
     *
     * @param array<string,string>|null $default_values The default values, keyed by field name, for address fields
     *
     * @return self
     */
