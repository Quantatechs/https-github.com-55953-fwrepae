...
/**
 * IdentityProviderRequestResult Class Doc Comment
 *
 * @category Class
 ...
 */
class IdentityProviderRequestResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IdentityProviderRequestResult';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url The URL which should be opened in a new browser window / popup to get the user consent.
     *
     * @return self
     */
