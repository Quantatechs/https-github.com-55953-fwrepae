...
/**
 * DocumentQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class DocumentQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentQueryFilters';
    ...
    protected static $openAPITypes = [
        ...
        'range' => '\OpenAPI\Client\Model\DocumentQueryFiltersAllOfRange',
        'categories' => 'string[]',
        'enabled' => 'bool',
        'groups' => 'string[]',
        'brokers' => 'string[]',
    ...
    */
     ...
     * Gets range
     *
     * @return \OpenAPI\Client\Model\DocumentQueryFiltersAllOfRange|null
     */
     ...
     * Sets range
     *
     * @param \OpenAPI\Client\Model\DocumentQueryFiltersAllOfRange|null $range range
     *
     * @return self
     */
     ...
     * Sets categories
     *
     * @param string[]|null $categories The shared document categories
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Only used if the logged user can manage documents. When set, filters documents by their `enabled` status, either `true` or `false`.
     *
     * @return self
     */
     ...
     * Sets groups
     *
     * @param string[]|null $groups Either the ids or internal names of individual document owners' group
     *
     * @return self
     */
     ...
     * Sets brokers
     *
     * @param string[]|null $brokers Either the ids or identification methods of individual document owners' brokers
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param string|null $user Either the id or identifier of the document owner
     *
     * @return self
     */
     ...
     * Sets keywords
     *
     * @param string|null $keywords Used to filter documents containing that keywords in the the name or description (case insensitive)
     *
     * @return self
     */
