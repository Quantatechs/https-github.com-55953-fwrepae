...
/**
 * GeneralRecordsDataForSearch Class Doc Comment
 *
 * @category Class
 ...
 */
class GeneralRecordsDataForSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeneralRecordsDataForSearch';
    ...
    protected static $openAPITypes = [
        ...
        'query' => '\OpenAPI\Client\Model\GeneralRecordsDataForSearchAllOfQuery'
    ];
    ...
    */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\Group[]|null $groups The groups the authenticated user can use to filter user records
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BasicProfileFieldInput[]|null $basic_profile_fields The list of basic user profile fields that can be used as search filters. Only returned if searching user records.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CustomFieldDetailed[]|null $custom_profile_fields The list of custom user profile fields that can be used as search filters. Only returned if searching user records.
     *
     * @return self
     */
     ...
     * Gets query
     *
     * @return \OpenAPI\Client\Model\GeneralRecordsDataForSearchAllOfQuery|null
     */
     ...
     * Sets query
     *
     * @param \OpenAPI\Client\Model\GeneralRecordsDataForSearchAllOfQuery|null $query query
     *
     * @return self
     */
