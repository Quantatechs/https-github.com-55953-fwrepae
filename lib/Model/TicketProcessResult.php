 ...
 */
class TicketProcessResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TicketProcessResult';
    ...
    protected static $openAPITypes = [
        ...
        'transaction' => '\OpenAPI\Client\Model\TicketProcessResultAllOfTransaction'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('actually_processed', $data ?? [], null);
    ...
    */
     ...
     * Sets ticket_number
     *
     * @param string|null $ticket_number The ticket number identifier.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $actually_processed Flag indicating if the ticket was processed by this invocation or the ticket was already processed in a previous invocation. This will only  be true for the first invocation of the `process` service method.
     *
     * @return self
     */
    public function setActuallyProcessed($actually_processed)
    {
        if (is_null($actually_processed)) {
            throw new \InvalidArgumentException('non-nullable actually_processed cannot be null');
        }
     ...
     * Gets transaction
     *
     * @return \OpenAPI\Client\Model\TicketProcessResultAllOfTransaction|null
     */
     ...
     * Sets transaction
     *
     * @param \OpenAPI\Client\Model\TicketProcessResultAllOfTransaction|null $transaction transaction
     *
     * @return self
     */
