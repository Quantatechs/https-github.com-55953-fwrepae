 ...
 */
class DeviceEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceEdit';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The new device name. It must be unique per user.
     *
     * @return self
     */
