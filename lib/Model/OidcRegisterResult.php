...
/**
 * OidcRegisterResult Class Doc Comment
 *
 * @category Class
 ...
 */
class OidcRegisterResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OidcRegisterResult';
    ...
    */
     ...
     * Sets client_id
     *
     * @param string|null $client_id The assigned client id
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string|null $client_secret The assigned client secret
     *
     * @return self
     */
     ...
     *
     * @param int|null $client_id_issued_at Time at which the client id was issued, as a number of seconds since the epoch time (1970-01-01T0:0:0Z).
     *
     * @return self
     */
     ...
     *
     * @param int|null $client_secret_expires_at Time at which the client secret will expire. Cyclos never expires client secrets, so the result is always zero.
     *
     * @return self
     */
