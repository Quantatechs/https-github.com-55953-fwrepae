...
/**
 * OperatorGroupDataForEdit Class Doc Comment
 *
 * @category Class
 ...
 */
class OperatorGroupDataForEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperatorGroupDataForEdit';
    ...
    protected static $openAPITypes = [
        ...
        'operator_group' => '\OpenAPI\Client\Model\OperatorGroupDataForEditAllOfOperatorGroup',
        'can_edit' => 'bool',
        'can_remove' => 'bool'
    ];
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\User[]|null $restrict_payments_to_users Details of the currently set users in the `restrictPaymentsToUsers` property in `operatorGroup` (which have only the ids).
     *
     * @return self
     */
     ...
     * Gets operator_group
     *
     * @return \OpenAPI\Client\Model\OperatorGroupDataForEditAllOfOperatorGroup|null
     */
     ...
     * Sets operator_group
     *
     * @param \OpenAPI\Client\Model\OperatorGroupDataForEditAllOfOperatorGroup|null $operator_group operator_group
     *
     * @return self
     */
     ...
     * Sets can_edit
     *
     * @param bool|null $can_edit Can the authenticated user edit this operator group?
     *
     * @return self
     */
     ...
     * Sets can_remove
     *
     * @param bool|null $can_remove Can the authenticated user remove this operator group?
     *
     * @return self
     */
