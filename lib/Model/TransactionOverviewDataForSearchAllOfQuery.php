<?php
/**
 * TransactionOverviewDataForSearchAllOfQuery
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * TransactionOverviewDataForSearchAllOfQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionOverviewDataForSearchAllOfQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionOverviewDataForSearch_allOf_query';
    ...
    protected static $openAPITypes = [
        ...
        'ticket_statuses' => '\OpenAPI\Client\Model\TicketStatusEnum[]',
        'ticket_expiration' => '\DateTime[]',
        'recurring_payment_statuses' => '\OpenAPI\Client\Model\RecurringPaymentStatusEnum[]',
        'scheduled_payment_statuses' => '\OpenAPI\Client\Model\ScheduledPaymentStatusEnum[]',
        'payment_request_statuses' => '\OpenAPI\Client\Model\PaymentRequestStatusEnum[]',
        'payment_request_expiration' => '\DateTime[]',
        'external_payment_statuses' => '\OpenAPI\Client\Model\ExternalPaymentStatusEnum[]',
        'external_payment_expiration' => '\DateTime[]',
        'currencies' => 'string[]',
    ...
    protected static $openAPIFormats = [
        ...
        'external_payment_expiration' => 'date-time',
        'currencies' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'ticket_statuses' => false,
        'ticket_expiration' => false,
        'recurring_payment_statuses' => false,
        'scheduled_payment_statuses' => false,
        'payment_request_statuses' => false,
        'payment_request_expiration' => false,
        'external_payment_statuses' => false,
        'external_payment_expiration' => false,
        'currencies' => false,
        'from_account_types' => false,
        'to_account_types' => false,
        'pending_my_authorization' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'ticket_expiration' => 'ticketExpiration',
        ...
        'external_payment_expiration' => 'externalPaymentExpiration',
    ...
    protected static $setters = [
        ...
        'ticket_expiration' => 'setTicketExpiration',
        ...
        'external_payment_expiration' => 'setExternalPaymentExpiration',
    ...
    protected static $getters = [
        ...
        'ticket_expiration' => 'getTicketExpiration',
        ...
        'external_payment_expiration' => 'getExternalPaymentExpiration',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ticket_statuses', $data ?? [], null);
        $this->setIfExists('ticket_expiration', $data ?? [], null);
        $this->setIfExists('recurring_payment_statuses', $data ?? [], null);
        $this->setIfExists('scheduled_payment_statuses', $data ?? [], null);
        $this->setIfExists('payment_request_statuses', $data ?? [], null);
        $this->setIfExists('payment_request_expiration', $data ?? [], null);
        $this->setIfExists('external_payment_statuses', $data ?? [], null);
        $this->setIfExists('external_payment_expiration', $data ?? [], null);
        ...
        $this->setIfExists('pending_my_authorization', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string[]|null $authorization_roles Either internal names or ids of authorization roles. To match, transactions must be pending authorization in a level which can be authorized by any of the given roles.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\TicketStatusEnum[]|null $ticket_statuses Statuses used as search criteria applied only to transactions of kind `ticket`.
     *
     * @return self
     */
    public function setTicketStatuses($ticket_statuses)
    {
        if (is_null($ticket_statuses)) {
            throw new \InvalidArgumentException('non-nullable ticket_statuses cannot be null');
        }
    ...
    /**
     * Gets ticket_expiration
     *
     * @return \DateTime[]|null
     */
    public function getTicketExpiration()
    {
        return $this->container['ticket_expiration'];
    }

    /**
     * Sets ticket_expiration
     *
     * @param \DateTime[]|null $ticket_expiration The minimum / maximum date for ticket expiration. Only affects tickets. Is expressed an array, with the lower bound as first element, and the upper bound as second element. When only one element, will have just the lower bound. To specify only the upper bound, prefix the value with a comma.
     *
     * @return self
     */
    public function setTicketExpiration($ticket_expiration)
    {
        if (is_null($ticket_expiration)) {
            throw new \InvalidArgumentException('non-nullable ticket_expiration cannot be null');
        }
        $this->container['ticket_expiration'] = $ticket_expiration;
     ...
     *
     * @param \OpenAPI\Client\Model\ScheduledPaymentStatusEnum[]|null $scheduled_payment_statuses Statuses used as search criteria applied only to transactions of kind `scheduledPayment`. If this filter is not empty then pending scheduled payments will be excluded from the result. Pending scheduled payments does not have a status.
     *
     * @return self
     */
    public function setScheduledPaymentStatuses($scheduled_payment_statuses)
    {
        if (is_null($scheduled_payment_statuses)) {
            throw new \InvalidArgumentException('non-nullable scheduled_payment_statuses cannot be null');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\PaymentRequestStatusEnum[]|null $payment_request_statuses Statuses used as search criteria applied only to transactions of kind `paymentRequest`.
     *
     * @return self
     */
    public function setPaymentRequestStatuses($payment_request_statuses)
    {
        if (is_null($payment_request_statuses)) {
            throw new \InvalidArgumentException('non-nullable payment_request_statuses cannot be null');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\ExternalPaymentStatusEnum[]|null $external_payment_statuses Statuses used as search criteria applied only to transactions of kind `externalPayment`.
     *
     * @return self
     */
    public function setExternalPaymentStatuses($external_payment_statuses)
    {
        if (is_null($external_payment_statuses)) {
            throw new \InvalidArgumentException('non-nullable external_payment_statuses cannot be null');
        }
    ...
    /**
     * Gets external_payment_expiration
     *
     * @return \DateTime[]|null
     */
    public function getExternalPaymentExpiration()
    {
        return $this->container['external_payment_expiration'];
    }

    /**
     * Sets external_payment_expiration
     *
     * @param \DateTime[]|null $external_payment_expiration The minimum / maximum date for external payment expiration. Only affects external payments. Is expressed an array, with the lower bound as first element, and the upper bound as second element. When only one element, will have just the lower bound. To specify only the upper bound, prefix the value with a comma.
     *
     * @return self
     */
    public function setExternalPaymentExpiration($external_payment_expiration)
    {
        if (is_null($external_payment_expiration)) {
            throw new \InvalidArgumentException('non-nullable external_payment_expiration cannot be null');
        }
        $this->container['external_payment_expiration'] = $external_payment_expiration;
     ...
     *
     * @param bool|null $pending_my_authorization When set to true will only return transactions (`payment`, `recurringPayment` or `scheduledPayment`) in pending authorization state that the logged user can authorize
     *
     * @return self
     */
    public function setPendingMyAuthorization($pending_my_authorization)
    {
        if (is_null($pending_my_authorization)) {
            throw new \InvalidArgumentException('non-nullable pending_my_authorization cannot be null');
        }
