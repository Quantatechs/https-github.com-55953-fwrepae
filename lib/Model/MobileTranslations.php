...
/**
 * MobileTranslations Class Doc Comment
 *
 * @category Class
 ...
 */
class MobileTranslations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MobileTranslations';
    ...
    */
     ...
     * Sets locale
     *
     * @param string|null $locale The locale represented by this language, in either of the following formats: `<2-letter lowercase language code>` or `<2-letter lowercase language code>`_`<2-letter uppercase country code>`.
     *
     * @return self
     */
     ...
     * Sets translations
     *
     * @param array<string,string>|null $translations The translation keys / values for the mobile application
     *
     * @return self
     */
