<?php
/**
 * TransactionViewAllOfFeesOnAuthorization
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * TransactionViewAllOfFeesOnAuthorization Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionViewAllOfFeesOnAuthorization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionView_allOf_feesOnAuthorization';
    ...
    */
     ...
     * Sets total_amount
     *
     * @param float|null $total_amount Indicates the total amount to be paid, including fees.
     *
     * @return self
     */
