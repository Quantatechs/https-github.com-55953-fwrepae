...
/**
 * PaymentAwaitingFeedbackQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentAwaitingFeedbackQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentAwaitingFeedbackQueryFilters';
    ...
    */
     ...
     * Sets related_user
     *
     * @param string|null $related_user The user that received the payment feedback in reference to the user specified in the path. Should be either the id or some other allowed identification (login name, email, etc).
     *
     * @return self
     */
