...
/**
 * AcceptOrReschedulePaymentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AcceptOrReschedulePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AcceptOrReschedulePaymentRequest';
    ...
    */
     ...
     * Sets comments
     *
     * @param string|null $comments A comment the payer can set.
     *
     * @return self
     */
     ...
     * Sets process_date
     *
     * @param \DateTime|null $process_date The date the payment request must be processed.
     *
     * @return self
     */
