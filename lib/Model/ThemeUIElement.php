...
/**
 * ThemeUIElement Class Doc Comment
 *
 * @category Class
 ...
 */
class ThemeUIElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThemeUIElement';
    ...
    protected static $setters = [
        ...
        'advanced_definitions' => 'setAdvancedDefinitions',
    ...
    protected static $getters = [
        ...
        'advanced_definitions' => 'getAdvancedDefinitions',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('advanced_definitions', $data ?? [], null);
        $this->setIfExists('custom_style', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets content
     *
     * @param string|null $content The content of this element
     *
     * @return self
     */
     ...
     * Sets definitions
     *
     * @param string|null $definitions Base LESS variables.
     *
     * @return self
     */
    ...
    /**
     * Gets advanced_definitions
     *
     * @return string|null
     */
    public function getAdvancedDefinitions()
    {
        return $this->container['advanced_definitions'];
    }

    /**
     * Sets advanced_definitions
     *
     * @param string|null $advanced_definitions Advanced (based on the base ones) LESS variables.
     *
     * @return self
     */
    public function setAdvancedDefinitions($advanced_definitions)
    {
        if (is_null($advanced_definitions)) {
            throw new \InvalidArgumentException('non-nullable advanced_definitions cannot be null');
        }
        $this->container['advanced_definitions'] = $advanced_definitions;
     ...
     * Sets custom_style
     *
     * @param string|null $custom_style Customized CSS.
     *
     * @return self
     */
    public function setCustomStyle($custom_style)
    {
        if (is_null($custom_style)) {
            throw new \InvalidArgumentException('non-nullable custom_style cannot be null');
        }
