...
/**
 * UserVouchersQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class UserVouchersQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserVouchersQueryFilters';
    ...
    protected static $openAPITypes = [
        ...
        'relation' => '\OpenAPI\Client\Model\UserVouchersQueryFiltersAllOfRelation',
    ...
    */
     ...
     * Gets relation
     *
     * @return \OpenAPI\Client\Model\UserVouchersQueryFiltersAllOfRelation|null
     * @deprecated
     */
     ...
     * Sets relation
     *
     * @param \OpenAPI\Client\Model\UserVouchersQueryFiltersAllOfRelation|null $relation relation
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets redeem_period
     *
     * @param \DateTime[]|null $redeem_period For redeemed, or starting with 4.15, voucher transactions, use `GET /voucher-transactions` instead.   The minimum / maximum voucher transaction date. Only used when searching for redeemed, not bought vouchers. Is expressed an array, with the lower bound as first element, and the upper bound as second element. When only one element, will have just the lower bound. To specify only the upper bound, prefix the value with a comma.
     *
     * @return self
     * @deprecated
     */
