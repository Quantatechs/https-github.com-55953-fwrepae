...
class ExportFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets content_type
     *
     * @param string|null $content_type Indicates the content type (mime type) for the generated content.
     *
     * @return self
     */
     ...
     * Sets binary
     *
     * @param bool|null $binary Indicates whether the content generated by this format is binary (true) or textual (false)
     *
     * @return self
     */
     ...
     * Sets encoding
     *
     * @param string|null $encoding Indicates the character encoding for the textual content. Only returned `binary` is false.
     *
     * @return self
     */
