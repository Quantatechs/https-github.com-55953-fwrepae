 ...
 */
class DocumentDataForSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentDataForSearch';
    ...
    protected static $openAPITypes = [
        ...
        'query' => '\OpenAPI\Client\Model\DocumentQueryFilters'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('manage_categories', $data ?? [], null);
        $this->setIfExists('can_manage_individual', $data ?? [], null);
    ...
    */
     ...
     * Sets categories
     *
     * @param \OpenAPI\Client\Model\EntityReference[]|null $categories Visible document categories
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $manage_categories Either internal names of ids of categories the logged user can manage
     *
     * @return self
     */
    public function setManageCategories($manage_categories)
    {
        if (is_null($manage_categories)) {
            throw new \InvalidArgumentException('non-nullable manage_categories cannot be null');
        }
     ...
     *
     * @param bool|null $can_manage_individual Indicates whether the logged user can manage individual documents of managed users
     *
     * @return self
     */
    public function setCanManageIndividual($can_manage_individual)
    {
        if (is_null($can_manage_individual)) {
            throw new \InvalidArgumentException('non-nullable can_manage_individual cannot be null');
        }
     ...
     * Gets query
     *
     * @return \OpenAPI\Client\Model\DocumentQueryFilters|null
     */
     ...
     * Sets query
     *
     * @param \OpenAPI\Client\Model\DocumentQueryFilters|null $query query
     *
     * @return self
     */
