...
/**
 * ProcessDynamicDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class ProcessDynamicDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProcessDynamicDocument';
    ...
    */
     ...
     * Sets form_fields
     *
     * @param array<string,string>|null $form_fields Holds the form field values, keyed by field internal name or id. The format of the value depends on the custom field type.
     *
     * @return self
     */
