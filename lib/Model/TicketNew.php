 ...
 */
class TicketNew implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TicketNew';
    ...
    protected static $openAPITypes = [
        ...
        'order_id' => 'string',
        'expires_after' => '\OpenAPI\Client\Model\TicketNewAllOfExpiresAfter'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('success_webhook', $data ?? [], null);
    ...
    */
     ...
     * Sets cancel_url
     *
     * @param string|null $cancel_url The url to redirect when canceling the approve ticket flow. If an `orderId` is given then it will be added as a query parameter to this url when redirect as well as the ticket number too.
     *
     * @return self
     */
     ...
     * Sets success_url
     *
     * @param string|null $success_url The url to redirect after successful approving a ticket.  If an `orderId` is given then it will be added as a query parameter to this url when redirect as well as the ticket number too.
     *
     * @return self
     */
     ...
     *
     * @param string|null $success_webhook The url to be invoked by the server after successfully approving a  ticket. If an `orderId` is given then it will be added as a query parameter to this url when redirect as well as the ticket number too.
     *
     * @return self
     */
    public function setSuccessWebhook($success_webhook)
    {
        if (is_null($success_webhook)) {
            throw new \InvalidArgumentException('non-nullable success_webhook cannot be null');
        }
     ...
     * Gets expires_after
     *
     * @return \OpenAPI\Client\Model\TicketNewAllOfExpiresAfter|null
     */
     ...
     * Sets expires_after
     *
     * @param \OpenAPI\Client\Model\TicketNewAllOfExpiresAfter|null $expires_after expires_after
     *
     * @return self
     */
