...
/**
 * DataForChangeForgottenPassword Class Doc Comment
 *
 * @category Class
 ...
 */
class DataForChangeForgottenPassword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataForChangeForgottenPassword';
    ...
    */
     ...
     *
     * @param string|null $security_question If configured in Cyclos will be the security question that needs to be answered in order to complete the forgotten password reset request. If required and the user hasn't set the security answher, the user won't be able to use the forgot password functionality.
     *
     * @return self
     */
     ...
     * Sets principals
     *
     * @param \OpenAPI\Client\Model\UserRegistrationPrincipal[]|null $principals The list of user identifications (principals) which can be used in the current channel
     *
     * @return self
     */
