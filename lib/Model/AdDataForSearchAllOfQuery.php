...
/**
 * AdDataForSearchAllOfQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class AdDataForSearchAllOfQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdDataForSearch_allOf_query';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('return_editable', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets user
     *
     * @param string|null $user Either id or an identification, such as login name, e-mail, etc, for the advertisement owner. The allowed identification methods are those the authenticated user can use on keywords search.
     *
     * @return self
     */
     ...
     * Sets brokers
     *
     * @param string[]|null $brokers Either ids or an identifications, such as login name, e-mail, etc, for the brokers of the advertisement owner. Can only be used when searching with a broker himself or admin.
     *
     * @return self
     */
     ...
     * Sets groups
     *
     * @param string[]|null $groups Array of either id or internal names of user groups the advertisement owner must belong to
     *
     * @return self
     */
     ...
     *
     * @param bool|null $return_editable Whether to return the editable property. Passing `true` will impact the performance a bit, as for each returned advertisement some statuses and permissions need to be checked.
     *
     * @return self
     */
    public function setReturnEditable($return_editable)
    {
        if (is_null($return_editable)) {
            throw new \InvalidArgumentException('non-nullable return_editable cannot be null');
        }
