...
/**
 * MyMarketplacePermissions Class Doc Comment
 *
 * @category Class
 ...
 */
class MyMarketplacePermissions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MyMarketplacePermissions';
    ...
    */
     ...
     * Sets enable
     *
     * @param bool|null $enable Are advertisements enabled? Only returned if there is an authenticated user.
     *
     * @return self
     */
     ...
     * Sets manage
     *
     * @param bool|null $manage Can manage own advertisements? Only returned if there is an authenticated user.
     *
     * @return self
     */
     ...
     * Sets questions
     *
     * @param bool|null $questions Are questions enabled? Only returned if there is an authenticated user.
     *
     * @return self
     */
