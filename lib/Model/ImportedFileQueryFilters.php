...
/**
 * ImportedFileQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class ImportedFileQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportedFileQueryFilters';
    ...
    protected static $openAPITypes = [
        ...
        'statuses' => '\OpenAPI\Client\Model\ImportedFileStatusEnum[]'
    ];
    ...
    */
     ...
     *
     * @param \DateTime[]|null $creation_period The minimum / maximum creation date. Is expressed an array, with the lower bound as first element, and the upper bound as second element. When only one element, will have just the lower bound. To specify only the upper bound, prefix the value with a comma.
     *
     * @return self
     */
     ...
     * Sets kinds
     *
     * @param \OpenAPI\Client\Model\ImportedFileKind[]|null $kinds The kinds to filter
     *
     * @return self
     */
     ...
     * Sets statuses
     *
     * @param \OpenAPI\Client\Model\ImportedFileStatusEnum[]|null $statuses The statuses to filter
     *
     * @return self
     */
