...
/**
 * ContactResult Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactResult';
    ...
    */
     ...
     * Sets custom_values
     *
     * @param array<string,string>|null $custom_values Holds the values for contact custom fields which are set to be returned on list, keyed by field internal name
     *
     * @return self
     */
