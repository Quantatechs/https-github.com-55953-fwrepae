...
/**
 * UserVoucherTransactionsQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class UserVoucherTransactionsQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserVoucherTransactionsQueryFilters';
    ...
    protected static $openAPITypes = [
        ...
        'amount_range' => 'float[]',
        'kinds' => '\OpenAPI\Client\Model\VoucherTransactionKind[]',
    ...
    */
     ...
     * Sets amount_range
     *
     * @param float[]|null $amount_range The minimum / maximum amount. For bought vouchers, is the voucher amount. For redeemed vouchers, is the redeem amount.
     *
     * @return self
     */
     ...
     * Sets kinds
     *
     * @param \OpenAPI\Client\Model\VoucherTransactionKind[]|null $kinds The kind of the voucher transaction.
     *
     * @return self
     */
     ...
     * Sets date_period
     *
     * @param \DateTime[]|null $date_period The minimum / maximum voucher transaction date. Is expressed an array, with the lower bound as first element, and the upper bound as second element. When only one element, will have just the lower bound. To specify only the upper bound, prefix the value with a comma.
     *
     * @return self
     */
