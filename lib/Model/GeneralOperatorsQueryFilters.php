...
/**
 * GeneralOperatorsQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class GeneralOperatorsQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeneralOperatorsQueryFilters';
    ...
    */
     ...
     * Sets user_groups
     *
     * @param string[]|null $user_groups Either id or internal names of user groups / group sets
     *
     * @return self
     */
     ...
     * Sets broker
     *
     * @param string|null $broker Either id or a principal (login name, e-mail, etc) of the user broker
     *
     * @return self
     */
