...
/**
 * OrderQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderQueryFilters';
    ...
    */
     ...
     * Sets related_user
     *
     * @param string|null $related_user Either id or an identification, such as login name, e-mail, etc, for the seller or buyer according whether we are searching for purchases or sales. The allowed identification methods are those the authenticated user can use on keywords search.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime[]|null $creation_period The minimum / maximum order creation date. Is expressed an array, with the lower bound as first element, and the upper bound as second element. When only one element, will have just the lower bound. To specify only the upper bound, prefix the value with a comma.
     *
     * @return self
     */
     ...
     * Sets sales
     *
     * @param bool|null $sales Are we searching for sales or purchases? If not specified it's assumed purchases (i.e `false`)
     *
     * @return self
     */
     ...
     * Sets statuses
     *
     * @param \OpenAPI\Client\Model\OrderStatusEnum[]|null $statuses statuses
     *
     * @return self
     */
     ...
     * Sets product_number
     *
     * @param string|null $product_number The product number (with the mask if there is one) of an advertisement contained in the orders.
     *
     * @return self
     */
