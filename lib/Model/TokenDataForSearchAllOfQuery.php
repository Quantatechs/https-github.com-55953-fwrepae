...
/**
 * TokenDataForSearchAllOfQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class TokenDataForSearchAllOfQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenDataForSearch_allOf_query';
    ...
    protected static $openAPITypes = [
        ...
        'user' => 'string',
        'value' => 'string',
        'statuses' => '\OpenAPI\Client\Model\TokenStatusEnum[]'
    ];
    ...
    */
     ...
     *
     * @param \DateTime[]|null $activation_period The minimum / maximum token activation date.
     *
     * @return self
     */
     ...
     * Sets expiry_period
     *
     * @param \DateTime[]|null $expiry_period The minimum / maximum token expiry date.
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param string|null $user Either id or a principal (login name, e-mail, etc) for the token owner user
     *
     * @return self
     */
     ...
     * Sets statuses
     *
     * @param \OpenAPI\Client\Model\TokenStatusEnum[]|null $statuses The desired token statuses
     *
     * @return self
     */
