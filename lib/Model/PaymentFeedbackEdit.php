...
/**
 * PaymentFeedbackEdit Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentFeedbackEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentFeedbackEdit';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('give_comments', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getGiveComments()
    {
        return $this->container['give_comments'];
    }

    /**
     * Sets give_comments
     *
     * @param string|null $give_comments The modified payer's comment
     *
     * @return self
     */
    public function setGiveComments($give_comments)
    {
        if (is_null($give_comments)) {
            throw new \InvalidArgumentException('non-nullable give_comments cannot be null');
        }
        $this->container['give_comments'] = $give_comments;
     ...
     * Sets reply_comments
     *
     * @param string|null $reply_comments The modified reply comment
     *
     * @return self
     */
     ...
     *
     * @param string|null $manager_comments The admin/broker comments
     *
     * @return self
     */
