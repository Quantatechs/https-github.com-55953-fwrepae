 ...
 */
class SessionResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SessionResult';
    ...
    protected static $openAPITypes = [
        ...
        'channel' => '\OpenAPI\Client\Model\EntityReference',
    ...
    */
     ...
     * Sets session_token
     *
     * @param string|null $session_token The session token
     *
     * @return self
     */
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date The session creation date
     *
     * @return self
     */
     ...
     * Sets remote_address
     *
     * @param string|null $remote_address The session remote address
     *
     * @return self
     */
     ...
     * Sets channel
     *
     * @param \OpenAPI\Client\Model\EntityReference|null $channel channel
     *
     * @return self
     */
     ...
     *
     * @param bool|null $current_session Whether the session is the current one
     *
     * @return self
     */
    public function setCurrentSession($current_session)
    {
        if (is_null($current_session)) {
            throw new \InvalidArgumentException('non-nullable current_session cannot be null');
        }
