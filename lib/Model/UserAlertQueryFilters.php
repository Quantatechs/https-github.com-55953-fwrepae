 ...
 */
class UserAlertQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserAlertQueryFilters';
    ...
    protected static $openAPITypes = [
        ...
        'types' => '\OpenAPI\Client\Model\UserAlertTypeEnum[]',
        'groups' => 'string[]',
        'brokers' => 'string[]',
        'user' => 'string'
    ];
    ...
    */
     ...
     * Sets date_period
     *
     * @param \DateTime[]|null $date_period The minimum / maximum alert date. Is expressed an array, with the lower bound as first element, and the upper bound as second element. When only one element, will have just the lower bound. To specify only the upper bound, prefix the value with a comma.
     *
     * @return self
     */
     ...
     * Sets types
     *
     * @param \OpenAPI\Client\Model\UserAlertTypeEnum[]|null $types The types of user alerts to search
     *
     * @return self
     */
     ...
     * Sets groups
     *
     * @param string[]|null $groups Either the ids or internal names of the alert user
     *
     * @return self
     */
     ...
     * Sets brokers
     *
     * @param string[]|null $brokers Either the ids or identification methods the alert user's brokers
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param string|null $user Either the id or identifier of the alert user
     *
     * @return self
     */
