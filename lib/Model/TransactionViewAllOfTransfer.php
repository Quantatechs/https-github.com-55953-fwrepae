...
/**
 * TransactionViewAllOfTransfer Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionViewAllOfTransfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionView_allOf_transfer';
    ...
    protected static $openAPITypes = [
        ...
        'a_rate' => 'float',
        'd_rate' => 'float',
        'transaction' => '\OpenAPI\Client\Model\TransferViewAllOfTransaction',
        'status_flows' => '\OpenAPI\Client\Model\TransferStatusFlowForTransferView[]',
        'can_chargeback' => 'bool',
        'operations' => '\OpenAPI\Client\Model\Operation[]',
        'confirmation_password_input' => '\OpenAPI\Client\Model\TransferViewAllOfConfirmationPasswordInput',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('status_flows', $data ?? [], null);
        $this->setIfExists('can_chargeback', $data ?? [], null);
    ...
    */
     ...
     * Gets transaction
     *
     * @return \OpenAPI\Client\Model\TransferViewAllOfTransaction|null
     */
     ...
     * Sets transaction
     *
     * @param \OpenAPI\Client\Model\TransferViewAllOfTransaction|null $transaction transaction
     *
     * @return self
     */
     ...
     * Gets status_flows
     *
     * @return \OpenAPI\Client\Model\TransferStatusFlowForTransferView[]|null
     */
     ...
     * Sets status_flows
     *
     * @param \OpenAPI\Client\Model\TransferStatusFlowForTransferView[]|null $status_flows List with each status this transfer has, with additional information, such as the flow and the log
     *
     * @return self
     */
    public function setStatusFlows($status_flows)
    {
        if (is_null($status_flows)) {
            throw new \InvalidArgumentException('non-nullable status_flows cannot be null');
        }
     ...
     * Sets can_chargeback
     *
     * @param bool|null $can_chargeback Can the authenticated user chargeback this transfer?
     *
     * @return self
     */
    public function setCanChargeback($can_chargeback)
    {
        if (is_null($can_chargeback)) {
            throw new \InvalidArgumentException('non-nullable can_chargeback cannot be null');
        }
     ...
     * Sets operations
     *
     * @param \OpenAPI\Client\Model\Operation[]|null $operations The list of custom operations the logged user can run over this transfer
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\TransferViewAllOfConfirmationPasswordInput|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\TransferViewAllOfConfirmationPasswordInput|null $confirmation_password_input confirmation_password_input
     *
     * @return self
     */
     ...
     * Sets export_formats
     *
     * @param \OpenAPI\Client\Model\ExportFormat[]|null $export_formats The formats which the data can be exported Not returned if this `TransferView` is already in a `TransactionView`.
     *
     * @return self
     */
