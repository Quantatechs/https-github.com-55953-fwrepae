...
/**
 * ContactDataForNewAllOfContact Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactDataForNewAllOfContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactDataForNew_allOf_contact';
    ...
    */
     ...
     * Sets contact
     *
     * @param string|null $contact The user which is the contact of a given owner. Can be either the id or another identifier, such as login name or e-mail, depending on the Cyclos configuration.
     *
     * @return self
     */
