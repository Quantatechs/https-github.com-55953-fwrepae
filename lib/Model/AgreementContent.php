...
/**
 * AgreementContent Class Doc Comment
 *
 * @category Class
 ...
 */
class AgreementContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgreementContent';
    ...
    */
     ...
     * Sets content
     *
     * @param string|null $content The HTML formatted content of the agreement
     *
     * @return self
     */
     ...
     *
     * @param int|null $content_version The version of the text for this agreement. When the text changes, the version is incremented.
     *
     * @return self
     */
     ...
     * Sets last_version
     *
     * @param int|null $last_version The current (last) version of the text for this agreement.
     *
     * @return self
     */
