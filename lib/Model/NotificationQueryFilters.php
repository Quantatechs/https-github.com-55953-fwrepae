...
/**
 * NotificationQueryFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class NotificationQueryFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationQueryFilters';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('only_new', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets only_unread
     *
     * @param bool|null $only_unread Boolean value indicating wether return only the unread notifications
     *
     * @return self
     */
    ...
    {
        return $this->container['only_new'];
    }

    /**
     * Sets only_new
     *
     * @param bool|null $only_new Boolean value indicating wether return only the new notifications received after the last view date tracked using `POST /notifications/viewed`
     *
     * @return self
     */
    public function setOnlyNew($only_new)
    {
        if (is_null($only_new)) {
            throw new \InvalidArgumentException('non-nullable only_new cannot be null');
        }
        $this->container['only_new'] = $only_new;
