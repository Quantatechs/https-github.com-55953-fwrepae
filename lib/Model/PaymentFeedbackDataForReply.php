...
/**
 * PaymentFeedbackDataForReply Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentFeedbackDataForReply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentFeedbackDataForReply';
    ...
    */
     ...
     * Sets comments
     *
     * @param string|null $comments Given comments for this payment feedback
     *
     * @return self
     */
     ...
     * Sets can_reply
     *
     * @param bool|null $can_reply Whether the user can reply for a given feedback
     *
     * @return self
     */
     ...
     * Sets deadline
     *
     * @param \DateTime|null $deadline The deadline until the reply is allowed. Null means there is no limit for reply and the user can reply while the feedback has not expired.
     *
     * @return self
     */
