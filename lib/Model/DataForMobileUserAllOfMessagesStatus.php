<?php
/**
 * DataForMobileUserAllOfMessagesStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DataForMobileUserAllOfMessagesStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class DataForMobileUserAllOfMessagesStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataForMobileUser_allOf_messagesStatus';
    ...
    */
     ...
     * Sets new_messages
     *
     * @param int|null $new_messages Indicates the number of received messages after the last view date (i.e `lastViewDate`).
     *
     * @return self
     */
     ...
     *
     * @param int|null $unread_messages Indicates the total number of unread messages.
     *
     * @return self
     */
     ...
     * Sets last_view_date
     *
     * @param \DateTime|null $last_view_date The last view date tracked by the server through `POST /messages/viewed`
     *
     * @return self
     */
