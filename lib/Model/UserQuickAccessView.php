...
/**
 * UserQuickAccessView Class Doc Comment
 *
 * @category Class
 ...
 */
class UserQuickAccessView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserQuickAccessView';
    ...
    protected static $openAPITypes = [
        'type' => '\OpenAPI\Client\Model\QuickAccessTypeEnum',
        'operation' => '\OpenAPI\Client\Model\Operation',
        'wizard' => '\OpenAPI\Client\Model\Wizard',
        'record_type' => '\OpenAPI\Client\Model\RecordType',
        'token_type' => '\OpenAPI\Client\Model\TokenType',
        'enabled' => 'bool',
        'original_order' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('original_order', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\QuickAccessTypeEnum|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\QuickAccessTypeEnum|null $type type
     *
     * @return self
     */
     ...
     * Sets operation
     *
     * @param \OpenAPI\Client\Model\Operation|null $operation operation
     *
     * @return self
     */
     ...
     * Sets record_type
     *
     * @param \OpenAPI\Client\Model\RecordType|null $record_type record_type
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param \OpenAPI\Client\Model\TokenType|null $token_type token_type
     *
     * @return self
     */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Is this quick access item enabled?
     *
     * @return self
     */
     ...
     * Sets original_order
     *
     * @param int|null $original_order The order this item originally has
     *
     * @return self
     */
    public function setOriginalOrder($original_order)
    {
        if (is_null($original_order)) {
            throw new \InvalidArgumentException('non-nullable original_order cannot be null');
        }
