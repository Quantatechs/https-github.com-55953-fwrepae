...
/**
 * NotificationSettingsDataForEdit Class Doc Comment
 *
 * @category Class
 ...
 */
class NotificationSettingsDataForEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationSettingsDataForEdit';
    ...
    protected static $openAPITypes = [
        ...
        'settings' => '\OpenAPI\Client\Model\NotificationSettingsDataForEditAllOfSettings',
        'payments' => '\OpenAPI\Client\Model\TransferType[]',
        'authorizable_payments' => '\OpenAPI\Client\Model\TransferType[]',
        'external_payments' => '\OpenAPI\Client\Model\TransferType[]',
        'voucher_configurations' => '\OpenAPI\Client\Model\EntityReference[]',
        'user_accounts' => '\OpenAPI\Client\Model\AccountType[]',
        'user_groups' => '\OpenAPI\Client\Model\Group[]',
        'message_categories' => '\OpenAPI\Client\Model\EntityReference[]',
    ...
    protected static $setters = [
        ...
        'message_categories' => 'setMessageCategories',
    ...
    protected static $getters = [
        ...
        'message_categories' => 'getMessageCategories',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('message_categories', $data ?? [], null);
    ...
    */
     ...
     * Gets settings
     *
     * @return \OpenAPI\Client\Model\NotificationSettingsDataForEditAllOfSettings|null
     */
     ...
     * Sets settings
     *
     * @param \OpenAPI\Client\Model\NotificationSettingsDataForEditAllOfSettings|null $settings settings
     *
     * @return self
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\Model\TransferType[]|null $payments The visible regular payment types. Only applicable for administrators, not users (members / brokers).
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\TransferType[]|null $authorizable_payments The visible regular payment types that require authorization. Only applicable for administrators, not users (members / brokers).
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\TransferType[]|null $external_payments The visible payment types that allow external payments. Only applicable for administrators, not users (members / brokers).
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\EntityReference[]|null $voucher_configurations The visible voucher configurations. Only applicable for administrators, not users (members / brokers).
     *
     * @return self
     */
     ...
     * Sets user_accounts
     *
     * @param \OpenAPI\Client\Model\AccountType[]|null $user_accounts The available accounts types for user payment notifications
     *
     * @return self
     */
     ...
     * Sets user_groups
     *
     * @param \OpenAPI\Client\Model\Group[]|null $user_groups The visible user groups. Only applicable for administrators, not users (members / brokers).
     *
     * @return self
     */
    ...
    /**
     * Gets message_categories
     *
     * @return \OpenAPI\Client\Model\EntityReference[]|null
     */
    public function getMessageCategories()
    {
        return $this->container['message_categories'];
    }

    /**
     * Sets message_categories
     *
     * @param \OpenAPI\Client\Model\EntityReference[]|null $message_categories The visible message categories. Only applicable for administrators, not users (members / brokers).
     *
     * @return self
     */
    public function setMessageCategories($message_categories)
    {
        if (is_null($message_categories)) {
            throw new \InvalidArgumentException('non-nullable message_categories cannot be null');
        }
        $this->container['message_categories'] = $message_categories;
     ...
     *
     * @param bool|null $forward_messages Use `settings.forwardMessages` instead.
     *
     * @return self
     * @deprecated
     */
