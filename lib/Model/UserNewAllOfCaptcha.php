...
/**
 * UserNewAllOfCaptcha Class Doc Comment
 *
 * @category Class
 ...
 */
class UserNewAllOfCaptcha implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserNew_allOf_captcha';
    ...
    */
     ...
     * Sets challenge
     *
     * @param string|null $challenge The captcha challenge identifier
     *
     * @return self
     */
     ...
     * Sets response
     *
     * @param string|null $response The captcha response, as informed by the user
     *
     * @return self
     */
