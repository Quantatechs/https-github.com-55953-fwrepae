<?php
/**
 * UserDataForNewAllOfContactInfoBinaryValues
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UserDataForNewAllOfContactInfoBinaryValues Class Doc Comment
 *
 * @category Class
 ...
 */
class UserDataForNewAllOfContactInfoBinaryValues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserDataForNew_allOf_contactInfoBinaryValues';
    ...
    protected static $openAPITypes = [
        'file_values' => 'array<string,\OpenAPI\Client\Model\StoredFile[]>',
        'image_values' => 'array<string,\OpenAPI\Client\Model\Image[]>'
    ];
    ...
    */
     ...
     * Gets file_values
     *
     * @return array<string,\OpenAPI\Client\Model\StoredFile[]>|null
     */
     ...
     * Sets file_values
     *
     * @param array<string,\OpenAPI\Client\Model\StoredFile[]>|null $file_values The values for custom fields of type `file`
     *
     * @return self
     */
     ...
     * Gets image_values
     *
     * @return array<string,\OpenAPI\Client\Model\Image[]>|null
     */
     ...
     * Sets image_values
     *
     * @param array<string,\OpenAPI\Client\Model\Image[]>|null $image_values The values for custom fields of type `image`
     *
     * @return self
     */
