<?php
/**
 * TransactionViewAllOfAuthorizationPermissions
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * TransactionViewAllOfAuthorizationPermissions Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionViewAllOfAuthorizationPermissions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionView_allOf_authorizationPermissions';
    ...
    */
     ...
     * Sets authorize
     *
     * @param bool|null $authorize The payment can be authorized.
     *
     * @return self
     */
     ...
     * Sets deny
     *
     * @param bool|null $deny The payment can be denied.
     *
     * @return self
     */
     ...
     * Sets cancel
     *
     * @param bool|null $cancel The payment can be cenceled regardless the current authorization level.
     *
     * @return self
     */
