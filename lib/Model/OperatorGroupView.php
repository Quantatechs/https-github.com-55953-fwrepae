...
/**
 * OperatorGroupView Class Doc Comment
 *
 * @category Class
 ...
 */
class OperatorGroupView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperatorGroupView';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'user' => '\OpenAPI\Client\Model\OperatorGroupViewAllOfUser',
        'can_edit' => 'bool',
        'description' => 'string',
        ...
        'unblock_token' => 'bool',
        'brokering' => 'bool',
        'restrict_payments_to_users' => '\OpenAPI\Client\Model\User[]',
        'operations' => '\OpenAPI\Client\Model\Operation[]',
        'records' => '\OpenAPI\Client\Model\RecordType[]',
        'accounts' => '\OpenAPI\Client\Model\OperatorGroupAccountView[]',
        'payments' => '\OpenAPI\Client\Model\OperatorGroupPaymentView[]',
    ...
    */
     ...
     * Gets user
     *
     * @return \OpenAPI\Client\Model\OperatorGroupViewAllOfUser|null
     */
     ...
     * Sets user
     *
     * @param \OpenAPI\Client\Model\OperatorGroupViewAllOfUser|null $user user
     *
     * @return self
     */
     ...
     * Sets can_edit
     *
     * @param bool|null $can_edit Can the authenticated user edit / remove this operator group?
     *
     * @return self
     */
     ...
     * Sets brokering
     *
     * @param bool|null $brokering Can operators of this group perform brokering operations?
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\User[]|null $restrict_payments_to_users When set, operators of this group will only be able to perform payments to one of this users
     *
     * @return self
     */
     ...
     * Sets operations
     *
     * @param \OpenAPI\Client\Model\Operation[]|null $operations Custom operators that operators of this group will only be able to run
     *
     * @return self
     */
     ...
     * Sets records
     *
     * @param \OpenAPI\Client\Model\RecordType[]|null $records Record types that operators of this group will only be able to access
     *
     * @return self
     */
     ...
     * Gets accounts
     *
     * @return \OpenAPI\Client\Model\OperatorGroupAccountView[]|null
     */
     ...
     * Sets accounts
     *
     * @param \OpenAPI\Client\Model\OperatorGroupAccountView[]|null $accounts Settings for the access operators will have over owner accounts.
     *
     * @return self
     */
     ...
     * Gets payments
     *
     * @return \OpenAPI\Client\Model\OperatorGroupPaymentView[]|null
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\Model\OperatorGroupPaymentView[]|null $payments Settings for payments that can be performed by operators.
     *
     * @return self
     */
