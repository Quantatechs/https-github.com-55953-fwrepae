...
/**
 * UserProductsPermissions Class Doc Comment
 *
 * @category Class
 ...
 */
class UserProductsPermissions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserProductsPermissions';
    ...
    protected static $openAPITypes = [
        'view' => 'bool',
        'individual' => '\OpenAPI\Client\Model\EntityReference[]',
        'group' => '\OpenAPI\Client\Model\EntityReference[]',
        'group_set' => '\OpenAPI\Client\Model\EntityReference[]'
    ];
    ...
    */
     ...
     * Sets view
     *
     * @param bool|null $view Can the authenticated user view assigned products?
     *
     * @return self
     */
     ...
     * Sets individual
     *
     * @param \OpenAPI\Client\Model\EntityReference[]|null $individual The individual products assigned to the user
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param \OpenAPI\Client\Model\EntityReference[]|null $group The products assigned to the user's group
     *
     * @return self
     */
     ...
     * Sets group_set
     *
     * @param \OpenAPI\Client\Model\EntityReference[]|null $group_set The products assigned to the user's group set
     *
     * @return self
     */
